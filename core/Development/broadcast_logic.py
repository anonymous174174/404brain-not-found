...
class CustomTensor:
    ...
    # --- Other operators from original code ---
    # __sub__, __truediv__, pow, exp, log, sin, cos, sqrt, matmul, etc.
    # The logic remains the same, but they now benefit from the more robust
    # broadcasting and can be composed with the new operations.
    # [Your existing code for these operators would go here]
